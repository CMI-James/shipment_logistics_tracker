...
const ClientCarousel = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center text-center bg-blue-900 text-white p-8">
      <h2 className="text-3xl font-bold mb-4">Satisfied Clients</h2>
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="flex mb-4">
                  {[...Array(5)].map((star, i) => (
                    <svg
                      key={i}
                      className={`w-6 h-6 ${i < testimonial.rating ? 'text-red-500' : 'text-gray-400'}`}
                      fill="currentColor"
                      viewBox="0 0 24 24"
                    >
