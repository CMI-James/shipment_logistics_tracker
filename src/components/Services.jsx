...
const services = [
  {
    id: 1,
    icon: (
      <FaHouseChimney className="text-orange-500 text-6xl mb-4 flex justify-center items-center" />
    ),
    title: "WAREHOUSING",
    description:
  ...
  },
  {
    id: 2,
    icon: (
      <VscPackage className="text-orange-500 text-6xl mb-4 flex justify-center items-center" />
    ),
  ...
  },
  {
    id: 3,
    icon: (
      <MdDirectionsRailwayFilled className="text-orange-500 text-6xl mb-4 flex justify-center items-center" />
    ),
      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-14 ">
          {services.map((service, index) => (
            <div
              key={service.id}
              className="bg-white p-8  shadow-lg rounded-lg relative z-10"
              data-aos="fade-up"
        ...
        >
          {" "}
        <p  className="text-orange-500 font-bold mt-8 inline-block hover:underline"
          data-aos="fade-up"
          data-aos-delay="400">  All Services</p>
        </Link>
      </div>
    </div>
  );
